...
class MainWindow(MainWindowClass, Ui_MainWindow):
    ...
    def cardScanned(self, card):
        ...
        QMetaObject.invokeMethod(self.parent, "startLogin", Qt.QueuedConnection, Q_ARG(QtGui.QMainWindow, self.parent), Q_ARG(QString, user["realname"]), Q_ARG(QString, status), Q_ARG(int, user["last_visit"]))
